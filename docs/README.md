...
<body>
  ...
  <h3 id="top">
    Research <a href="https://angular.dev/overview">Angular</a> and
  ...
  <ol>
    ...
    <li><a href="#THREE"><b>Cypress End-to-End Tests</b></a></li>
  </ol>
  ...
  <p><img alt="" src="images/greenCircle.png">
    ...
    This diagram has the links to the web page screenshots.
  </p>
  <p><img alt="" src="images/greenCircle.png">
    1.2. The backend repository.
    The local web storage is used alone or together with backend repository on external Node.js 'Express' server.
  </p>
  ...
  <p><img alt="" src="images/greenCircle.png">
    1.3. The typescript sources are in directory <a href="https://github.com/k1729p/Study27/blob/main/src/app">app</a>.
  </p>
  <p>
  ...
  <p><img alt="" src="images/greenCircle.png">
    1.4. The reports are generated using 'pdfmake'. The reports examples:
  </p>
  <ul>
    <li>
  ...
  <a href="#top">Back to the top of the page</a>
  <hr>
  <h3 id="THREE">❸ Cypress End-to-End Tests</h3>

  <p>Action:<br>
    <img alt="" src="images/orangeHR-500.png"><br>
    <img alt="" src="images/orangeSquare.png"> Use the batch file
    <a href="https://github.com/k1729p/Study27/blob/main/0_batch/03%20Cypress%20tests.bat">
      <i>"03 Cypress tests.bat"</i></a> to start the Cypress tests.<br>
    <img alt="" src="images/orangeHR-500.png">
  </p>
  <p><img alt="" src="images/greenCircle.png">
    3.1 The test scripts <a href="https://github.com/k1729p/Study27/blob/main/cypress/e2e">directory</a>.
  </p>
  <p><img alt="" src="images/greenCircle.png">
    3.2. Some of the test screenshots generated by Cypress:
  </p>
  <ul>
    <li>
      <a
        ...
        Read department and employee</a> <i>(using repository PostgreSQL)</i>
    </li>
    <li>
      <a
        ...
        Create department and employee</a> <i>(using repository PostgreSQL)</i>
    </li>
    <li>
      <a
        ...
        Update department and employee</a> <i>(using repository PostgreSQL)</i>
    </li>
    <li>
      <a
        ...
        Delete department and employee</a> <i>(using repository PostgreSQL)</i>
    </li>
    <li>
      <a
        ...
        Transfer employees</a> <i>(using repository WebStorage)</i>
    </li>
    <li>
      <a
        ...
        Locate employee</a> <i>(using repository MongoDB)</i>
    </li>
    <li>
      <a
        ...
        Open report</a> <i>(using repository MongoDB)</i>
    </li>
  </ul>
